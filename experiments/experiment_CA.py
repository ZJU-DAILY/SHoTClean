...
def main():
    ...
    for i in range(10):
        ...
        for j in range(exp_time):
            ...
            dirty_series = assist.read_data(input_file_name, ",")
            dirty_series = assist.add_noise(dirty_series, drate, seed)
            SHoTClean_S = SHoTClean_S1(dirty_series, s_max, s_min, T, is_soft=True)
            start_time = time.time()
            ...
            dirty_series = assist.read_data(input_file_name, ",")
            dirty_series = assist.add_noise(dirty_series, drate, seed)
            SHoTClean_P = SHoTClean_P1(dirty_series, s_max, s_min, T, is_soft=True)
            start_time = time.time()
