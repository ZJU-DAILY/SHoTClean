...
def main():
    ...
    for i in range(10):
        ...
        for j in range(exp_time):
            ...
            # assist.save_data(dirty_series, f"../results/Multi/WADI/cleaned/Dirty_{drate}.data")
            rmsDirty = assist.calc_rms(dirty_series)
            print(f"Dirty RMS error is {round(rmsDirty, 3)}")
            # exit()
            ...
            # assist.save_data(result_series_MTCSC, f"../results/Multi/WADI/cleaned/MTCSC_{drate}.data")
            ...
            # assist.save_data(result_series_screen, f"../results/Multi/WADI/cleaned/SCREEN_{drate}.data")
            #
            # SpeedAcc
            dirty_series = assist.read_data(input_file_name, ",")
            dirty_series = assist.add_noise(dirty_series, drate, seed)
            ...
            # assist.save_data(result_series_speedacc, f"../results/Multi/WADI/cleaned/SpeedAcc_{drate}.data")
            #
            # EWMA
            dirty_series = assist.read_data(input_file_name, ",")
            dirty_series = assist.add_noise(dirty_series, drate, seed)
            ...
            # assist.save_data(result_series_expsmooth, f"../results/Multi/WADI/cleaned/EWMA_{drate}.data")
            ...
            # assist.save_data(result_series_lsgreedy, f"../results/Multi/WADI/cleaned/LsGreedy_{drate}.data")

            # SHoTClean B
            dirty_series = assist.read_data(input_file_name, ",")
            dirty_series = assist.add_noise(dirty_series, drate, seed)
            SHoTClean_B_Soft = SHoTClean_B(dirty_series, s_max, s_min, 10, is_soft=True)
            start_time = time.time()
            ...
            # assist.save_data(result_series_SHoTClean_B_Soft, f"../results/Multi/WADI/cleaned/B-Soft_{drate}.data")
            ...
            print(f"SHoTClean S RMS: {rms_SHoTClean_S_Soft}, Cost: {cost_SHoTClean_S_Soft}, Acc: {acc_SHoTClean_S_Soft}, Time: {end_time - start_time}")
            ...
            print(f"SHoTClean P RMS: {rms_SHoTClean_P_Soft}, Cost: {cost_SHoTClean_P_Soft}, Acc: {acc_SHoTClean_P_Soft}, Time: {time_cost}")
            #
            # SHoTClean C
            dirty_series = assist.read_data(input_file_name, ",")
            dirty_series = assist.add_noise(dirty_series, drate, seed)
            ...
            print(
                f"SHoTClean C RMS: {rms_SHoTClean_C_Soft}, Cost: {cost_SHoTClean_C_Soft}, Acc: {acc_SHoTClean_C_Soft}, Time: {end_time - start_time}")
            # assist.save_data(result_series_SHoTClean_C_Soft, f"../results/Multi/WADI/cleaned/C-Soft_{drate}.data")
    ...
    print(total_acc)
    print(total_time)
    name = ["Methods" ,"MTCSC", "SCREEN", "SpeedAcc", "EWMA", "LsGreedy", "SHoTClean-B", "SHoTClean-S", "SHoTClean-P", "SHoTClean-C"]
    write_file_name = "../results/Multi/WADI/RMS.csv"
    assist.write_csv(write_file_name, name, total_drate, total_rms)
    write_file_name = "../results/Multi/WADI/COST.csv"
    assist.write_csv(write_file_name, name, total_drate, total_cost)
    write_file_name = "../results/Multi/WADI/ACC.csv"
    assist.write_csv(write_file_name, name, total_drate, total_acc)
    write_file_name = "../results/Multi/WADI/TIME.csv"
