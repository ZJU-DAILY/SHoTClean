...
def main():
    ...
    for i in range(10):
        ...
        for j in range(exp_time):
            ...
            # print(f"BASE A Soft: {rms_SHoTClean_P}, {cost_SHoTClean_P}, {acc_SHoTClean_P}, {end_time - start_time}")
            # exit()
