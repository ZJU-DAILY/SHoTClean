...
def main():
    ...
    for i in range(10):
        ...
        for j in range(exp_time):
            ...
            print(
                f"SHoTClean S RMS: {rms_SHoTClean_S_Soft}, Cost: {cost_SHoTClean_S_Soft}, Acc: {acc_SHoTClean_S_Soft}, Time: {end_time - start_time}")
            ...
            # assist.save_data(result_series_MTCSC, f"../results/Multi/PSM/MTCSC_{drate}.data")
            ...
            # assist.save_data(result_series_SHoTClean_B_Soft, f"../results/Multi/PSM/B-Soft_{drate}.data")
            # assist.save_data(result_series_SHoTClean_C_Soft, f"../results/Multi/PSM/C-Soft_{drate}.data")
            # exit()
