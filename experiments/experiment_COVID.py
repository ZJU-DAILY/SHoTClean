...
def main():
    ...
    input_file_name = "COVID19/US_confirmed.csv"
    s_max = 999999999
    s_min = 0
    TT = 10
    T = 10
    ...
    for i in range(1):
        ...
        for j in range(exp_time):
            ...
            # plt.plot(truth[:5000], 'black', label='Truth')
            # # plt.plot(ori, 'g--', label='Noise')
