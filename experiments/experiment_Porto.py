...
def main():
    ...
    for id in range(1, 11):
        input_file_name = f"Porto/porto_{id}.data"
        s_max = 0.05
        s_min = -0.05
        TT = 10
        ...
        for i in range(10):
            ...
            for j in range(exp_time):
                ...
                # print(f"MTCSC RMS: {rms_MTCSC}, Cost: {cost_MTCSC}, Num: {acc_MTCSC}, Time: {time_cost}")
                # exit()
                ...
                # print(f"SCREEN RMS: {rms_screen}, Cost: {cost_screen}, Num: {acc_screen}, Time: {time_cost}")
                ...
                # print(f"SpeedAcc RMS: {rms_speedacc}, Cost: {cost_speedacc}, Num: {acc_speedacc}, Time: {time_cost}")
                ...
                # print(f"EWMA RMS: {rms_expsmooth}, Cost: {cost_expsmooth}, Num: {acc_expsmooth}, Time: {time_cost}")
                ...
                # print(f"LsGreedy RMS: {rms_lsgreedy}, Cost: {cost_lsgreedy}, Num: {acc_lsgreedy}, Time: {time_cost}")
                ...
                # print(f"BASE S-Multi RMS: {rms_SHoTClean_S_Soft}, Cost: {cost_SHoTClean_S_Soft}, Num: {acc_SHoTClean_S_Soft}, Time: {end_time - start_time}")
                ...
                total_rms[i][5] += rms_SHoTClean_P_Soft
                total_cost[i][5] += cost_SHoTClean_P_Soft
                total_acc[i][5] += acc_SHoTClean_P_Soft
                total_time[i][5] += time_cost

                # print(f"BASE P-Single RMS: {rms_SHoTClean_P_Soft}, Cost: {cost_SHoTClean_P_Soft}, Num: {acc_SHoTClean_P_Soft}, Time: {time_cost}")
                ...
                total_rms[i][7] += rms_SHoTClean_C_Soft
                total_cost[i][7] += cost_SHoTClean_C_Soft
                total_acc[i][7] += acc_SHoTClean_C_Soft
                total_time[i][7] += end_time - start_time
                # print(f"BASE C RMS: {rms_SHoTClean_C_Soft}, Cost: {cost_SHoTClean_C_Soft}, Num: {acc_SHoTClean_C_Soft}, Time: {end_time - start_time}")
        ...
        print(total_acc)
        print(total_time)
        name = ["Methods" ,"MTCSC", "SCREEN", "SpeedAcc", "EWMA", "LsGreedy","SHoTClean-S", "SHoTClean-P", "SHoTClean-C"]
        write_file_name = f"../results/Multi/Porto/RMS_{id}.csv"
        assist.write_csv(write_file_name, name, total_drate, total_rms)
        write_file_name = f"../results/Multi/Porto/COST_{id}.csv"
        assist.write_csv(write_file_name, name, total_drate, total_cost)
        write_file_name = f"../results/Multi/Porto/ACC{id}.csv"
        assist.write_csv(write_file_name, name, total_drate, total_acc)
        write_file_name = f"../results/Multi/Porto/TIME_{id}.csv"
