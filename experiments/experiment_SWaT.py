...
def main():
    ...
    for i in range(10):
        ...
        for j in range(exp_time):
            ...
            print(
                f"SHoTClean P RMS: {rms_SHoTClean_P_Soft}, Cost: {cost_SHoTClean_P_Soft}, Acc: {acc_SHoTClean_P_Soft}, Time: {time_cost}")
    ...
    write_file_name = f"../results/Multi/SWaT/RMS.csv"
    assist.write_csv(write_file_name, name, total_drate, total_rms)
    write_file_name = f"../results/Multi/SWaT/COST.csv"
    assist.write_csv(write_file_name, name, total_drate, total_cost)
    write_file_name = f"../results/Multi/SWaT/ACC.csv"
    assist.write_csv(write_file_name, name, total_drate, total_acc)
    write_file_name = f"../results/Multi/SWaT/TIME.csv"
