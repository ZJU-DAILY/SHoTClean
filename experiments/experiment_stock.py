...
def main():
    ...
    for i in range(10):
        ...
        for j in range(exp_time):
            ...
            dirty_series = assist.read_data(input_file_name, ",")
            dirty_series = assist.add_noise(dirty_series, drate, seed)
            BASE_Hard = SHoTClean_B1(dirty_series, s_max, s_min, is_soft=False)
            start_time = time.time()
            ...
            dirty_series = assist.read_data(input_file_name, ",")
            dirty_series = assist.add_noise(dirty_series, drate, seed)
            BASE_L_Hard = SHoTClean_S1(dirty_series, s_max, s_min, 10, is_soft=False)
            start_time = time.time()
            ...
            dirty_series = assist.read_data(input_file_name, ",")
            dirty_series = assist.add_noise(dirty_series, drate, seed)
            BASE_A_Hard = SHoTClean_P1(dirty_series, s_max, s_min, 10, is_soft=False)
            start_time = time.time()
            ...
            # dirty_series = assist.read_data(input_file_name, ",")
            # dirty_series = assist.add_noise(dirty_series, drate, seed)
            # assist.save_data(dirty_series, f"../results/One/stock/dirty_series_{drate}_{seed}.data")
            # assist.save_data(result_series_MTCSC, f"../results/One/stock/MTCSC_{drate}_{seed}.data")
            # assist.save_data(result_series_screen, f"../results/One/stock/SCREEN_{drate}_{seed}.data")
            # assist.save_data(result_series_speedacc, f"../results/One/stock/SpeedAcc_{drate}_{seed}.data")
            # assist.save_data(result_series_expsmooth, f"../results/One/stock/EWMA_{drate}_{seed}.data")
            # assist.save_data(result_series_lsgreedy, f"../results/One/stock/LsGreedy_{drate}_{seed}.data")
            # assist.save_data(result_series_SHoTClean_Soft, f"../results/One/stock/SHoTClean_B_Soft_{drate}_{seed}.data")
            # assist.save_data(result_series_SHoTClean_S, f"../results/One/stock/SHoTClean_S_Soft_{drate}_{seed}.data")
            # assist.save_data(result_series_SHoTClean_P, f"../results/One/stock/SHoTClean_P_Soft_{drate}_{seed}.data")
            # exit()
